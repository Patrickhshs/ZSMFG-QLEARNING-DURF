...
if __name__ == '__main__':
    ...
    models = [spawn_ai(args.algo, device, env, handles[0], args.algo + '-me', args.max_steps), spawn_ai(args.algo, device, env, handles[1], args.algo + '-opponent', args.max_steps)]
    runner = tools.Runner(device, env, handles, args.map_size, args.max_steps, models, play,
